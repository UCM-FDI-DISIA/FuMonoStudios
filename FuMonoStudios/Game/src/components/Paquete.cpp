...
Paquete::Paquete(Distrito dis, Calle c, const std::string& remitente, TipoPaquete Tp, bool corr, NivelPeso Np, int p, bool f, bool cart, const std::stirng& nombreCalle) :
