...
int main(int argc, char* argv[]) {
    ...
    const char* textToWrite = "D�a 1: El vagabundo estar� en su caja de cart�n en la calle donde est� la oficina. El juego te indicar� que puedes hablar con �l y te forzar� a hablar con �l.";
